                    ...
                    showDialog(
                        ...
                        builder: (context) {
                          return NetLoadingDialog(
                            ...
                            loading: true,
                            loadingText: "配置中...",
                            requestCallBack: fetchconfig(
                                context, currentusername, currentpassword),
                          );
                        });
                  }
                } catch (e) {
  ...
  try {
    ...
    if (usernamecheck == 'Empty') {
      ...
      if (usernamecheck['password'] == password) {
        ...
        //拉取兰空图床配置
        var lskyhostresult = await MySqlUtils.queryLankong(username: username);
        ...
        if (githubresult == 'Error') {
          ...
          try {
            ...
            FLog.error(
                ...
                dataLogType: DataLogType.ERRORS.toString());
            return showCupertinoAlertDialog(
                context: context, title: "错误", content: "拉取github图床配置失败,请重试!");
          }
        }
        //拉取Imgur图床配置
