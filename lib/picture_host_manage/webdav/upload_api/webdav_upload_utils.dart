...
import 'package:horopic/picture_host_manage/webdav/upload_api/webdav_upload_request.dart';
...
class UploadManager {
  ...
  Future<void> upload(
    ...
    try {
      ...
      await client.writeFromFile(path, uploadPath + fileName,
          onProgress: createCallback(path, fileName));
