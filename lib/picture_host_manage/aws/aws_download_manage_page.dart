...
class AwsUpDownloadManagePage extends StatefulWidget {
  ...
  @override
  AwsUpDownloadManagePageState createState() => AwsUpDownloadManagePageState();
}

class AwsUpDownloadManagePageState extends State<AwsUpDownloadManagePage> {
  ...
  _createDownloadListItem() {
      ...
      list.add(GestureDetector(
          onLongPress: () {
            showCupertinoAlertDialogWithConfirmFunc(
                ...
                onConfirm: () async {
                  Navigator.pop(context);
                  Global.awsDownloadList.remove(Global.awsDownloadList[i]);
    ...
    List<Widget> list2 = [
      ...
      ValueListenableBuilder(
          valueListenable:
              downloadManager.getBatchDownloadProgress(Global.awsDownloadList),
          builder: (context, value, child) {
            return Container(
              height: 10,
              margin: const EdgeInsets.symmetric(vertical: 4),
