...
class GithubFileInformationState extends State<GithubFileInformation> {
  ...
  getGithubFileInformation() async {
    var githubFileInformation = await GithubManageAPI.getRepoFileContent(
        widget.fileMap['showedUsername'], widget.fileMap['name'], widget.fileMap['path']);
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            subtitle: widget.fileMap['dir'] == '' ? const Text('根目录') : SelectableText(widget.fileMap['dir']),
          ),
          ListTile(
