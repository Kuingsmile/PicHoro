...
class Permissionutils {
  ...
  static Future<bool> askPermissionGallery() async => askForPermission(Permission.photos);
  static Future<bool> askPermissionMicrophone() async => askForPermission(Permission.videos);
  static Future<bool> askPermissionLocation() async => askForPermission(Permission.audio);
