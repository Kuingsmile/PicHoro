...
注：由于vlc播放器的限制，WebDAV的视频预览只能播放部分格式的视频。
...
- 2022-11-19: **V1.9.1**:
  ...
  - 新增：增加了对**兼容S3 API协议的平台**的支持，目前已测试通过的平台包括AWS S3，backblaze和cloudfare R2，其他平台只要兼容S3 API协议也可使用，但个人未全部测试，如果你使用了其他平台，欢迎反馈测试结果。
